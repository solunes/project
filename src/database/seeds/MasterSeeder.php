...
class MasterSeeder extends Seeder {
    ...
    public function run()
    {
        ...
        $node_task_alert = \Solunes\Master\App\Node::create(['name'=>'task-alert', 'location'=>'project', 'folder'=>'project', 'type'=>'child', 'parent_id'=>$node_task->id]);
        ...
        $node_duty_user = \Solunes\Master\App\Node::create(['name'=>'duty-user', 'location'=>'project', 'folder'=>'project', 'type'=>'child', 'parent_id'=>$node_duty->id]);
        $node_default_task = \Solunes\Master\App\Node::create(['name'=>'default-task', 'location'=>'project', 'folder'=>'project']);
        $node_default_task_howtos = \Solunes\Master\App\Node::create(['name'=>'default-task-howto', 'location'=>'project', 'folder'=>'project', 'type'=>'child', 'parent_id'=>$node_default_task->id]);
        ...
        $node_project_task_update = \Solunes\Master\App\Node::create(['name'=>'project-task-update', 'location'=>'project', 'folder'=>'project', 'type'=>'child', 'parent_id'=>$node_project_task->id]);
        $node_project_issue = \Solunes\Master\App\Node::create(['name'=>'project-issue', 'location'=>'project', 'folder'=>'project']);
        $node_project_issue_update = \Solunes\Master\App\Node::create(['name'=>'project-issue-update', 'location'=>'project', 'folder'=>'project', 'type'=>'child', 'parent_id'=>$node_project_issue->id]);
